...
const userConverter: FirestoreDB.FirestoreDataConverter<SockbaseAccount> = {
  ...
  fromFirestore: (
    snapshot: FirestoreDB.QueryDocumentSnapshot): SockbaseAccount => {
...
interface IUseUserData {
  ...
  getUserDataByUserIdOptionalAsync: (userId: string) => Promise<SockbaseAccount | null>
...
const useUserData = (): IUseUserData => {
  ...
  const getUserDataByUserIdOptionalAsync = async (userId: string): Promise<SockbaseAccount | null> =>
    await getUserDataByUserIdAsync(userId)
  ...
  return {
    ...
    getUserDataByUserIdOptionalAsync,
    getUserDataByUserIdAndEventIdAsync,
    getUserDataByUserIdAndStoreIdAsync,
    getUserDataByUserIdAndStoreIdOptionalAsync
  }
